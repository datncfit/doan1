                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="http://localhost/BaoCao/Login/ResetPassword" method="post">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="http://localhost/BaoCao/Login/Dangky">Create an Account!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="http://localhost/BaoCao/Login/">Already have an account? Login!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
