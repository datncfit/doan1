                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="http://localhost:8080/BaoCao/Login/TRANGDANGKY"  method="post">
                                ...
                                <button class="btn btn-primary btn-user btn-block" type="submit" name="submit">Đăng Ký</button>
