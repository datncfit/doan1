                    ...
                    <div class="col-lg-3 form-cols">
                        <div class="default-select" id="default-selects2">
                            <select>
                                ...
                                <?php
                                while ($row_categories = mysqli_fetch_assoc($data["Categorys"])){?>
                                    <option value="<?php echo $row_categories["id_category"] ?>"><?php echo $row_categories["name"] ?></option>
                                <?php
                                }
                                ?>
                            </select>
...
<section class="features-area">
    <div class="container">
        <div class="row">
            <?php
                while ($top4Cate = mysqli_fetch_assoc($data["top4Category"])){
                    ?>
                    <div class="col-lg-3 col-md-6">
                        <div class="single-feature">
                            <h4><?php echo $top4Cate["name"] ?></h4>
                            <p>
                                <?php echo $top4Cate["description"] ?>
                            </p>
                        </div>
                    </div>
            <?php
        ...
        <div class="row align-items-center">
            <div class="active-popular-post-carusel">
                <div class="single-popular-post d-flex flex-row">
                    <div class="thumb">
                        <img class="img-fluid" src="./public/template_master/img/p1.png" alt="">
                ...
                <div class="single-popular-post d-flex flex-row">
                    <div class="thumb">
                        <img src="./public/template_master/img/p2.png" alt="">
                        <a class="btns text-uppercase" href="#">view job post</a>
                    </div>
                    <div class="details">
                        <a href="#"><h4>Creative Designer</h4></a>
                ...
                <div class="single-popular-post d-flex flex-row">
                    <div class="thumb">
                        <img src="./public/template_master/img/p1.png" alt="">
                        <a class="btns text-uppercase" href="#">view job post</a>
                    </div>
                    <div class="details">
                        <a href="#"><h4>Creative Designer</h4></a>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="single-fcat">
                    <a href="category.html">
                        <img src="./public/template_master/img/o1.png" alt="">
                    </a>
                    <p>Accounting</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="single-fcat">
                    <a href="category.html">
                        <img src="./public/template_master/img/o2.png" alt="">
                    </a>
                    <p>Development</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="single-fcat">
                    <a href="category.html">
                        <img src="./public/template_master/img/o3.png" alt="">
                    </a>
                    <p>Technology</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="single-fcat">
                    <a href="category.html">
                        <img src="./public/template_master/img/o4.png" alt="">
                    </a>
                    <p>Media & News</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="single-fcat">
                    <a href="category.html">
                        <img src="./public/template_master/img/o5.png" alt="">
                    </a>
                    <p>Medical</p>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="single-fcat">
                    <a href="category.html">
                        <img src="./public/template_master/img/o6.png" alt="">
                    </a>
                    <p>Goverment</p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center d-flex">
            <div class="col-lg-8 post-list">
                ...
                <?php
                    while ($posts = mysqli_fetch_assoc($data["Posts"])){
                        ?>
                        <div class="single-post d-flex flex-row">
                            <div class="thumb">
                                <img width="100px" src="./public/uploads/<?php echo $posts["thumb"] ?>" alt="">
                                <ul class="tags">
                                    <li>
                                        <a href="#">Art</a>
                                    </li>
                            ...
                            <div class="details">
                                <div class="title d-flex flex-row justify-content-between">
                                    <div class="titles">
                                        <a href="single.html"><h4><?php echo $posts["name"] ?></h4></a>
                ...
                <div class="single-post d-flex flex-row">
                    <div class="thumb">
                        <img src="./public/template_master/img/post.png" alt="">
                        <ul class="tags">
                            <li>
                                <a href="#">Art</a>
                            </li>
                ...
                <div class="single-slidebar">
                    ...
                    <div class="active-relatedjob-carusel">
                        <div class="single-rated">
                            <img class="./public/template_master/img-fluid" src="img/r1.jpg" alt="">
                            <a href="single.html"><h4>Creative Art Designer</h4></a>
                            <h6>Premium Labels Limited</h6>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod temporinc ididunt ut dolore magna aliqua.
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 download-left">
                <img class="./public/template_master/img-fluid" src="img/d1.png" alt="">
            </div>
