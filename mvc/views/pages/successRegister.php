                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Cảm Ơn Nhà Tuyển Dụng Đã Gửi THông Tin Đăng Ký</h1>
                                        <h1 class="h4 text-gray-900 mb-4">Chúng Tôi Sẽ Gọi Cho Bạn Ngay Lập Tức Để Xác Nhận Thông Tin</h1>
                                    </div>
                                    <a href="http://localhost:8080/BaoCao/" class="btn btn-google btn-user btn-block">
